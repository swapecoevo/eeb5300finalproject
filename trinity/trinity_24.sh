...
# this is an array job. SLURM will run this script 6 times in parallel (#SBATCH$
        # each time SLURM will change the value of the variable SLURM_ARRAY_TAS$
        # we'll use a bash array and that variable to retrieve a diferent sample

# a bash array containing the sample IDs
LIST=($(echo T02_S198 O12_S185 L12_S182 G10_S76 C05_S33 I05_S126))
